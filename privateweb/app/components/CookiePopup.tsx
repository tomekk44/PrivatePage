...
export default function CookiePopup() {
  ...
  return (
    <div className="fixed bottom-4 left-1/2 -translate-x-1/2 w-[90%] md:w-150 bg-white shadow-xl rounded-xl p-5 border border-gray-200 flex flex-col md:flex-row items-center gap-4 animate-fadeIn z-50">
